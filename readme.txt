...
Tags: twitter, tweet, share, awe.sm, bit.ly, oauth
...
Now support OAuth! Might be a little beta though. Oh and it only works with Curl installed. Will fix this later.
...
= 3.0 =
* Now support OAuth! 
* Might be a little beta though. 
* only works with Curl installed. Will fix this later.
